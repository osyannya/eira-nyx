...
let
  cfg = config.eira.home.desktop.wrappers.wallpaper-switch;
  ...
  '';
in {
  options.eira.home.desktop.wrappers.wallpaper-switch = {
    enable = lib.mkEnableOption "Custom script to change wallpapers";
  };
