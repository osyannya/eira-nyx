...
let
  cfg = config.eira.system.virtualisation.microvms.onion-vault;
in {
  options.eira.system.virtualisation.microvms.onion-vault = {
    enable = lib.mkEnableOption "Tor Hidden Service file vault MicroVM";
  };
